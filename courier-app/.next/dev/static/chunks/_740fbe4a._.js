...
function DataProvider({ children }) {
    ...
    const [clients, setClientsState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DataProvider.useState": ()=>getInitialData('clients', defaultClients)
    }["DataProvider.useState"]);
    const [drivers, setDriversState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DataProvider.useState": ()=>getInitialData('drivers', defaultDrivers)
    }["DataProvider.useState"]);
    const [shipments, setShipmentsState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DataProvider.useState": ()=>getInitialData('shipments', defaultShipments)
    }["DataProvider.useState"]);
    const [staff, setStaffState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DataProvider.useState": ()=>getInitialData('staff', defaultStaff)
    }["DataProvider.useState"]);
    const [suppliers, setSuppliersState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "DataProvider.useState": ()=>getInitialData('suppliers', defaultSuppliers)
    }["DataProvider.useState"]);
    ...
    const setDrivers = (newDrivers)=>{
        ...
        if (mounted) {
            try {
                ...
                console.error('Error saving drivers:', error_0);
            }
        }
    };
    const setShipments = (newShipments)=>{
        ...
        if (mounted) {
            try {
                ...
                console.error('Error saving shipments:', error_1);
            }
        }
    };
    const setStaff = (newStaff)=>{
        ...
        if (mounted) {
            try {
                ...
                console.error('Error saving staff:', error_2);
            }
        }
    };
    const setSuppliers = (newSuppliers)=>{
        ...
        if (mounted) {
            try {
                ...
                console.error('Error saving suppliers:', error_3);
            }
        }
    };
...
//# sourceMappingURL=_740fbe4a._.js.map