...
export default function ShipmentsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'Pending': return 'bg-red-300 text-gray-800';
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-400 text-sm">Click &ldquo;+ Create New Shipment&rdquo; to add your first shipment</p>
                    </div>
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={shipment.id} className="table-row">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="btn-group-tight">
                        <button onClick={() => handleEdit(shipment)} className="action-btn action-btn-edit" title="Edit">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                          </svg>
                        </button>
                        <button onClick={() => handleDelete(shipment)} className="action-btn action-btn-delete" title="Delete">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
